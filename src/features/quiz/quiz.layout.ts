/** Shared max-width and horizontal padding shell for quiz screens. */
...
export const QUIZ_RESULT_CTA_CLASS =
  "flex h-auto min-h-14 w-full max-w-[20rem] items-center justify-center whitespace-normal px-6 py-3.5 text-center text-base leading-tight uppercase no-underline sm:min-h-16 sm:max-w-xs sm:py-4 sm:text-lg md:max-w-sm";
